...
import ${package}.test.SessionManagementService;
...
public class ${ClassNamePrefix}WarBuilder extends BasicWarBuilder {
  ...
  protected <T> ${ClassNamePrefix}WarBuilder(final Class<T> test) {
    ...
    addMavenDependenciesWithPersistence("${package}:silverpeas-${rootArtifactId}");
   ...
   * @return the instance of the war archive builder.
   */
  public ${ClassNamePrefix}WarBuilder addRESTWebServiceEnvironment() {
