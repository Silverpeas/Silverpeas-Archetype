...
/**
 * Integration tests about the deletion of ${ClassNamePrefix} contributions.
 */
...
public class ${ClassNamePrefix}ResourceDeletionIT extends ResourceDeletionTest {
  ...
  private ${ClassNamePrefix}Entity existingEntity;

  @Deployment
  public static Archive<?> createTestArchive() {
    return ${ClassNamePrefix}WarBuilder.onWarForTestClass(${ClassNamePrefix}ResourceDeletionIT.class)
  ...
  public void prepareTestResources() {
    ...
    existingEntity = new ${ClassNamePrefix}Entity(${ClassNamePrefix}.getById(EXPECTED_ID));
  }
