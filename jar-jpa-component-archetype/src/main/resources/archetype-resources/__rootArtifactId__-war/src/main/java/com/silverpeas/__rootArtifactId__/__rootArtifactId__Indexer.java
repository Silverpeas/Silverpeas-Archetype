 ...
 */
//FIXME : rename to <Moduleid>Indexer (module id first letter must be converted to upper case)
public class ${rootArtifactId}Indexer implements ComponentIndexerInterface {

  @Override
  public void index(MainSessionController mainSessionCtrl, ComponentContext context) throws Exception {
	  //TODO index your searchable module data
  }
}
