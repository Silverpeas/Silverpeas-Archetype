...
<% }
	...
	if (!componentExists) {
		...
		boolean spaceExists = StringUtil.isDefined(spaceIdFromRedirect) && (organizationCtrl.getSpaceInstById(spaceIdFromRedirect) != null);
		if (spaceExists) {
...
<frameset rows="<%=framesetRows%>" id="mainFramesetId" border="0"> <!-- Do not remove frameset's attribute "border" -->
  	<frame src="TopBar${className}.jsp" name="topFrame" marginwidth="0" marginheight="0" scrolling="no" noresize="noresize" frameborder="0"/>
  	<frame src="frameBottom${className}.jsp<%=frameBottomParams%>" name="bottomFrame" marginwidth="0" marginheight="0" scrolling="no" noresize="noresize" frameborder="0"/>
  	<% if (helper.displayPDCFrame()) { %>
	...
	<% } %>
	<frame src="../../clipboard/jsp/Idle${className}.jsp" name="IdleFrame" marginwidth="0" marginheight="0" scrolling="no" noresize="noresize" frameborder="0"/>
