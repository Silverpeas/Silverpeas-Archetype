...
<html>
  ...
  <body>
    <view:window>
      ...
      <view:frame>
        <view:board>
          Cette instance s'appelle <span class="${rootArtifactId}Name"><c:out value="${symbol_dollar}{browseContext[1]}" /></span>.<br/>
          Elle se situe dans l'espace <span class="${rootArtifactId}Name"><c:out value="${symbol_dollar}{browseContext[0]}" /></span>.
        </view:board>
      </view:frame>
    </view:window>
  </body>
